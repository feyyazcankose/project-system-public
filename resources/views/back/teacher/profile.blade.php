...
{{-- Header --}}
@section('header')
    @include('back.teacher.layouts.header')
    <style>
        .profile-pic-wrapper {
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    ...
                                    <form method="POST" action="{{ route('teacher.profilUpdate') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="card-body">
                                          ...
                                          <input type="file" name="file" class="form-control">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label>Rol</label>
                                                    <input type="text" readonly class="form-control" value="{{ $Rol }}"
                                                        >

                                                </div>
                                                <div class="form-group">
                                                    <label>Sicil Numarası</label>
                                                    <input type="text" readonly class="form-control" value="{{$Sicil}}"
                                                        >
